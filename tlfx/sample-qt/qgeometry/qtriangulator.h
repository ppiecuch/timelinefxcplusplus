...
QTriangleSet qTriangulate(const QGeometryData &path, uint hint = QVectorPath::PolygonHint | QVectorPath::OddEvenFill, const QTransform &matrix = QTransform());
QPolylineSet qPolyline(const qreal *polygon, int count, uint hint = QVectorPath::PolygonHint | QVectorPath::OddEvenFill, const QTransform &matrix = QTransform());
...
QPolylineSet qPolyline(const QGeometryData &path, uint hint = QVectorPath::PolygonHint | QVectorPath::OddEvenFill, const QTransform &matrix = QTransform());

void qStripifyProcess(QVector<unsigned int> &indices);
