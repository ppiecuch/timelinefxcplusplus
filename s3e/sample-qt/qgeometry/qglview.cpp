...
#ifdef QT_WIDGETS_LIB
QGLViewContainer::QGLViewContainer(QWidget *parent) : QWidget(parent), parent(parent), view(new QGLView())
{
    Q_ASSERT(view);
    container = new QWindowContainer(view);
...
QGLViewContainer::QGLViewContainer(QGLView *viewer, QWidget *parent) : QWidget(parent), parent(parent), view(viewer)
{
    Q_ASSERT(view);
    container = new QWindowContainer(view);
    QHBoxLayout *lay = new QHBoxLayout();
...
QGLViewContainer::~QGLViewContainer()
{
}
